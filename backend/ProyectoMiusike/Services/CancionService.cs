...
namespace ProyectoMiusike.Services
{
    public class CancionService : ICancionService
    {
        ...
        public async Task<IEnumerable<Cacion>> ObtenerTodasCanciones(int orderBy)
        {
            var cancionEntity = await windAppRepository.GetAllCanciones(orderBy);
            ...
            return mapper.Map<IEnumerable<Cacion>>(cancionEntity);
        }
    }
}
